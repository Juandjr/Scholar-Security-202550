...
class _ListNews extends StatelessWidget {
                                  ...
                                  ? Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: _buildCachedImage(
                                          publicaciones[i].uid!,
                                          publicaciones[i].imagenes![0], //nombre del archivo
                                          double.infinity,
                                          size.height * 0.35,
                                        ),
                                      ),
  ...
  Widget _buildCachedImage(String publicacionUid, String imageName, double width, double height) {
    // Construir la URL completa igual que en perfil_detalle_screen.dart
    String imageUrl = "${Environment.apiUrl}/uploads/publicaciones/$publicacionUid?imagenIndex=$imageName";
    // Validar formato de URL básico
    if (!imageUrl.startsWith('http://') && !imageUrl.startsWith('https://')) {
      print('ImageLoadError: Invalid URL format: $imageUrl');
      return Container(
        width: width,
        height: height,
    ...
    return CachedNetworkImage(
      ...
      errorWidget: (context, url, error) {
        print('ImageLoadError: Failed to load image from $url');
