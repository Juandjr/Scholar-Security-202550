    ...
    if (publicacion.imagenes == null || publicacion.imagenes!.isEmpty) {
      return SliverAppBar(
        ...
        actions: [
          ...
          /*Esta parte se aumenta para ocultar la parte de denunciar, en la parte de abajo 
          se utiliza :const SizedBox() la cual encierra toda la propierdad que se hace a 
          continuación.*/
                        ...
                        return Container(
                          height: authService.state.usuario!.uid.trim() ==
                                  publicationBloc
                                      ...
                                      .trim()
                              //cuando el usuario es el mismo que quiere modificar 19/Octubre/2023
                              ? 120.0
                              : 55.0,
                          decoration: const BoxDecoration(
                            // color: Colors.white,
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                /* 
                                Esta parte del código se comenta debido a que la funcionalidad 
                                de "Denunciar" no tiene una función determina dentro del alcance 
                                de esta primera fase, a continuación la líneas de código comentadas
                                */
